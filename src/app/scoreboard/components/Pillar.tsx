...
const Pillar: React.FC<PillarProps> = ({ name, nim, score, order }) => {
  ...
  return (
    <div
      className={`w-[32%] max-w-[16rem] flex flex-col items-center justify-center gap-4 absolute ${order === 1 ? "bottom-1 md:-bottom-12 lg:bottom-8" : "-bottom-5 md:-bottom-24 lg:-bottom-7"} -translate-x-1/2`}
      style={{
        left: pillarPosition(),
      }}
    >
      <div className="py-2 px-1 flex flex-col items-center justify-around h-48 md:h-80 bg-white w-[95%] border-primaryDark-400 border-[3px] rounded-xl shadow-xl">
        ...
        <div className="text-center">
          <p className="font-koulen text-lg lg:text-3xl md:text-2xl line-clamp-2 uppercase">{name}</p>
